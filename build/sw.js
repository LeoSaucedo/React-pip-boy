...
self.addEventListener('fetch', function(event) {
  ...
  if (event.request.method === 'GET') {
    ...
    if (requestUrl.hostname.includes('api.') || requestUrl.hostname.includes('stream.')) {
      event.respondWith(
        fetch(event.request)
          .then(response => {
    ...
    else if (urlsToCache.includes(requestUrl.pathname) || requestUrl.pathname.endsWith('.js') || requestUrl.pathname.endsWith('.css')) {
      event.respondWith(
